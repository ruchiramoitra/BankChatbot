...
/**
 * Created by Ruchira on 07-07-2017.
 */
...
public class ChatMessageAdapter extends ArrayAdapter<ChatMessage> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (viewType == MY_MESSAGE) {
            ...
            humantext = (TextView) convertView.findViewById(R.id.text);

            humantext.setText(getItem(position).getContent());
            ...
            TextView humantext = (TextView) convertView.findViewById(R.id.text);
            humantext.setText(getItem(position).getContent());
